...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                    ...
                    ${taskCompleteValue}
                    <td><button type="button" onclick="edittask(${index})" class="text-primary" style="color:black !important; outline:none;"><i class="fa fa-edit"></i>Edit</button></td>
                    <td><button type="button" class="text-success" style="outline:none; color:#F1EB19 ;" id=${index}><i class="fa fa-check-square-o"></i>Complete</button></td>
                    <td><button type="button" onclick="deleteitem(${index})" class="text-danger" style="outline:none;"><i class="fa fa-trash"></i>Delete</button></td>
                </tr>`;
    });
